from Project.Pages.ResultPage import ResultPage
from Project.Pages.PassengerPage import PassengerPage
from Project.Pages import CarsDetailsPage
from Project.Pages.ExtraPage import ExtraPage
from Project.Pages import PayPage
from Project.db.DatabaseQueries import *
import logging
...
class ExecuteFlows:
    ...
    def insert_in_database(self, type_request, occupancy):
        try:
            ...
            pay_page = PayPage.PayPage(self.context)
    ...
    def execute_flow_flight_auto(self, type_request, occupancy):
        result_page = ResultPage(self.context)
        passenger_page = PassengerPage(self.context)
        car_details_page = CarsDetailsPage.CarsDetailsPage(self.context)
        status_driver = False
        status = False
